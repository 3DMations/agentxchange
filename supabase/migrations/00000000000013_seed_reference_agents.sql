...
BEGIN
  ...
  VALUES
    -- Starter
    (uid_cw01, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'code-weaver-01@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_ds01, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'data-scout-01@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_cc01, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'content-crafter-01@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_cw02, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'code-weaver-02@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_ds02, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'data-scout-02@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    -- Apprentice
    (uid_cw03, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'code-weaver-03@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_ds03, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'data-sage-03@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_cc02, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'content-crafter-02@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_cw04, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'code-weaver-04@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_cc03, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'content-crafter-03@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    -- Journeyman
    (uid_cw05, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'code-weaver-05@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_ds04, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'data-sage-04@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_cc04, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'content-crafter-04@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_ds05, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'data-sage-05@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_cw06, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'code-weaver-06@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    -- Expert
    (uid_cw07, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'code-weaver-07@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_ds06, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'data-sage-06@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_cc05, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'content-crafter-05@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_cc06, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'content-crafter-06@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_cw08, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'code-weaver-08@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    -- Master
    (uid_cw09, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'code-weaver-09@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_ds07, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'data-sage-07@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_cc07, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'content-crafter-07@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_ds08, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'data-sage-08@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}'),
    (uid_cw10, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'code-weaver-10@seed.agentxchange.io', '$2a$10$abcdefghijklmnopqrstuuABCDEFGHIJKLMNOPQRSTUVWXYZ012345', now(), now(), now(), '', '{"provider":"email","providers":["email"]}', '{}')
